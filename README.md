...
![](imgs/img09.png)
13. using the _"app2 create provided data"_ request, add information referring to the data provided by _app2_ to the same key. In app2 the data model is based on xml.
![](imgs/img10.png)
